...
public class SidePaneManager {
    ...
    private Map<String, Integer> getPreferredPositions() {
        ...
        String[] componentNames = Globals.prefs.getStringArray(JabRefPreferences.SIDE_PANE_COMPONENT_NAMES, null);
        String[] componentPositions = Globals.prefs.getStringArray(JabRefPreferences.SIDE_PANE_COMPONENT_PREFERRED_POSITIONS, null);
