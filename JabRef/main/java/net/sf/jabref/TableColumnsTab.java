...
class TableColumnsTab extends JPanel implements PrefsTab {
    ...
    public void setValues() {
        fileColumn.setSelected(_prefs.isFileColumn());
        pdfColumn.setSelected(_prefs.isPdfColumn());
        urlColumn.setSelected(_prefs.isUrlColumn());
        preferUrl.setSelected(!_prefs.isPreferUrlDoi());
        preferDoi.setSelected(_prefs.isPreferUrlDoi());
        fileColumn.setSelected(_prefs.isFileColumn());
        arxivColumn.setSelected(_prefs.isArxivColumn());

        extraFileColumns.setSelected(_prefs.isExtraFileColumns());
        if (extraFileColumns.isSelected()) {
            String[] desiredColumns = _prefs.getStringArray(null, JabRefPreferences.getListOfFileColumns());
        ...
        boolean oldShowOneLetterHeadingForIconColumns = _prefs.isShowOneLetterHeadingForIconColumns();
        showOneLetterHeadingForIconColumns.setSelected(oldShowOneLetterHeadingForIconColumns);

        tableRows.clear();
        String[] names = _prefs.getStringArray(JabRefPreferences.COLUMN_NAMES, null), 
        		lengths = _prefs.getStringArray(JabRefPreferences.COLUMN_WIDTHS, null);
    ...
    public void storeSettings() {
        _prefs.setFileColumn(fileColumn.isSelected());
        _prefs.setPdfColumn(pdfColumn.isSelected());
        _prefs.setUrlColumn(urlColumn.isSelected());
        _prefs.setPreferUrlDoi(preferDoi.isSelected());
        JabRefPreferences.setArxivColumn(arxivColumn.isSelected());

        _prefs.setExtraFileColumns(extraFileColumns.isSelected());
        if (extraFileColumns.isSelected() && !listOfFileColumns.isSelectionEmpty()) {
            ...
            _prefs.setListOfFileColumns(_prefs.putStringArray(selections));
        }
        else {
        	_prefs.setListOfFileColumns(_prefs.putStringArray(new String[] {}));
        }

        _prefs.setShowOneLetterHeadingForIconColumns(showOneLetterHeadingForIconColumns.isSelected());
