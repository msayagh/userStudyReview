...
public class ImportInspectionDialog extends JDialog implements ImportInspector, OutputPrinter {
    ...
    private class OkListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            if (Globals.prefs.isWarnAboutDuplicatesInInspection()) {
                for (BibtexEntry entry : entries) {
                    ...
                    if (entry.isGroupHit()) {
                        ...
                        if (cbm.isSelected()) {
                            Globals.prefs.setWarnAboutDuplicatesInInspection(false);
                        }
            ...
            Globals.prefs.setGenerateKeysAfterInspection(autoGenerate.isSelected());
            ...
            if (!selected.isEmpty()) {
                ...
                Util.setAutomaticFields(selected, Globals.prefs.isOverwriteOwner(),
