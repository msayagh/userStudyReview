...
class XmpPrefsTab extends JPanel implements PrefsTab {
    ...
    public void setValues() {
        tableRows.clear();
        String[] names = JabRefPreferences.getInstance().getStringArray(JabRefPreferences.XMP_PRIVACY_FILTERS, null);
        Collections.addAll(tableRows, names);
        rowCount = tableRows.size() + 5;

        privacyFilterCheckBox.setSelected(JabRefPreferences.getInstance().isUseXmpPrivacyFilter());
    }
    ...
    public void storeSettings() {
        ...
        JabRefPreferences.getInstance().setUseXmpPrivacyFilter(privacyFilterCheckBox.isSelected());
    }
