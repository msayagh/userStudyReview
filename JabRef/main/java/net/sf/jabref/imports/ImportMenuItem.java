            ...
            if (bibtexResult != null) {
                if (!openInNew) {
                    ...
                    if (Globals.prefs.isUseImportInspectionDialog() &&
                            (Globals.prefs.isUseImportInspectionDialogForSingle()
                        ...
                        boolean generateKeys = Globals.prefs.isGenerateKeysAfterInspection();
                        ...
                        if (Globals.prefs.isUnmarkAllEntriesBeforeImporting()) {
                    ...
                    frame.addTab(bibtexResult.getDatabase(), bibtexResult.getFile(),
                            bibtexResult.getMetaData(), Globals.prefs.getDefaultEncoding(), true);
    ...
    private ParserResult mergeImportResults(List<ImportFormatReader.UnknownFormatImport> imports) {
        ...
        for (ImportFormatReader.UnknownFormatImport importResult : imports) {
            ...
            if (ImportFormatReader.BIBTEX_FORMAT.equals(importResult.format)) {
                ...
                Util.setAutomaticFields(entries, Globals.prefs.isOverwriteOwner(),
                        Globals.prefs.isOverwriteTimeStamp(),
                        !openInNew && Globals.prefs.isMarkImportedEntries()); // set timestamp and owner
