...
public class FileLinksUpgradeWarning implements PostOpenAction {
    ...
    public void performAction(BasePanel panel, ParserResult pr) {
        ...
        boolean offerChangeSettings = !Globals.prefs.isFileColumn() || !showsFileInGenFields();
    ...
    private void makeChanges(BasePanel panel, ParserResult pr, boolean upgradePrefs,
        ...
        if (upgradePrefs) {
            ...
            Globals.prefs.setPdfColumn(Boolean.FALSE);
            Globals.prefs.setFileColumn(Boolean.TRUE);
