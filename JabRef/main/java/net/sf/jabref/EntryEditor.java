...
public class EntryEditor extends JPanel implements VetoableChangeListener, EntryContainer {
    ...
    public EntryEditor(JabRefFrame frame_, BasePanel panel_, BibtexEntry entry_) {
        ...
        if (prefs.isShowSource() && prefs.getBoolean(JabRefPreferences.DEFAULT_SHOW_SOURCE)) {
    ...
    public JComponent getExtra(String string, final FieldEditor ed) {
        ...
        if ((fieldName.equals(Globals.prefs.getTimeStampField()))
    ...
    private void setupSourcePanel() {
        ...
        source.setFont(new Font("Monospaced", Font.PLAIN, Globals.prefs.getFontSize()));
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                if (oldValue != null) {
                    if (JabRefPreferences.getInstance().isAvoidOverwritingKey()) {
                    ...
                    else if (JabRefPreferences.isWarnBeforeOverwritingKey()) {
                        ...
                        if (cbm.isSelected()) {
                            JabRefPreferences.getInstance().setWarnBeforeOverwritingKey(false);
                        }
