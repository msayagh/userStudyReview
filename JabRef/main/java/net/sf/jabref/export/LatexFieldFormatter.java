...
public class LatexFieldFormatter implements FieldFormatter {
    ...
    private LatexFieldFormatter(boolean neverFailOnHashes) {
        ...
        this.resolveStringsAllFields = Globals.prefs.isResolveStringsAllFields();
        valueDelimitersZero = Globals.prefs.getValueDelimiters(0);
        valueDelimitersOne = Globals.prefs.getValueDelimiters(1);
        doNotResolveStringsFors = Globals.prefs.getStringArray(null, JabRefPreferences.getDoNotResolveStringsFor());
        writefieldWrapfield = Globals.prefs.isWriteFieldAddSpaces();
    }
