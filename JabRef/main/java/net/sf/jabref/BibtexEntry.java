...
public class BibtexEntry
{
    ...
    {
        String[] res = _type.getOptionalFields();
        if (res == null) {
            return res;
        } else {
    ...
    {
        String[] res = _type.getRequiredFields();
        if (res == null) {
            return res;
        } else {
    ...
    {
        return Globals.prefs.getStringArray(null, JabRefPreferences.getWritefieldUserdefinedOrder());
    }
