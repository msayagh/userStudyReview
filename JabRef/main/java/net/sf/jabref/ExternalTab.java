...
public class ExternalTab extends JPanel implements PrefsTab {
	...
	public void setValues() {
		...
		bibLocationAsFileDir.setSelected(_prefs.isBibLocationAsFileDir());
		bibLocAsPrimaryDir.setSelected(JabRefPreferences.getInstance().isBib_loc_as_primary_dir());
		bibLocAsPrimaryDir.setEnabled(bibLocationAsFileDir.isSelected());
		runAutoFileSearch.setSelected(_prefs.isRunAutomaticFileSearch());
		regExpTextField.setText(_prefs.get(JabRefPreferences.REG_EXP_SEARCH_EXPRESSION_KEY));
		allowFileAutoOpenBrowse.setSelected(_prefs.isAllowFileAutoOpenBrowse());

		emailSubject.setText(_prefs.getEmailSubject());
		openFoldersOfAttachedFiles.setSelected(_prefs.isOpenFoldersOfAttachedFiles());

		if (_prefs.isUseRegExpSearch()) {
			useRegExpComboBox.setSelected(true);
		} else if (JabRefPreferences.getInstance().isAutolinkExactKeyOnly()) {
	...
	public void storeSettings() {
		...
		_prefs.setUseRegExpSearch(useRegExpComboBox.isSelected());
		...
		_prefs.setBibLocationAsFileDir(bibLocationAsFileDir.isSelected());
		//   _prefs.putBoolean(JabRefPreferences.BIB_LOC_AS_PRIMARY_DIR, bibLocAsPrimaryDir.isSelected());
		JabRefPreferences.setAutolinkExactKeyOnly(matchExactKeyOnly.isSelected());
		_prefs.setRunAutomaticFileSearch(runAutoFileSearch.isSelected());
		_prefs.setAllowFileAutoOpenBrowse(allowFileAutoOpenBrowse.isSelected());
		_prefs.setEmailSubject(emailSubject.getText());
		_prefs.setOpenFoldersOfAttachedFiles(openFoldersOfAttachedFiles.isSelected());
	}
