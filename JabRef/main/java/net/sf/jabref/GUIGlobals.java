...
public class GUIGlobals {
    ...
    public static void updateEntryEditorColors() {
        GUIGlobals.activeBackground = JabRefPreferences.getInstance().getColor(null, JabRefPreferences.getInstance().getActiveFieldEditorBackgroundColor());
        GUIGlobals.validFieldBackgroundColor = JabRefPreferences.getInstance().getColor(null, JabRefPreferences.getInstance().getValidFieldBackgroundColor());
        GUIGlobals.invalidFieldBackgroundColor = JabRefPreferences.getInstance().getColor(null, JabRefPreferences.getInstance().getInvalidFieldBackgroundColor());
        GUIGlobals.editorTextColor = JabRefPreferences.getInstance().getColor(null, JabRefPreferences.getFieldEditorTextColor());
    }
