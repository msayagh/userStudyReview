...
class NameFieldAutoCompleter extends AbstractAutoCompleter {
    ...
    public NameFieldAutoCompleter(String[] fieldNames, boolean lastNameOnlyAndSeparationBySpace) {
        ...
        if (Globals.prefs.isAutoCompFF()) {
            autoCompFF = true;
            autoCompLF = false;
        } else if (Globals.prefs.isAutoCompLF()) {
            autoCompFF = false;
            autoCompLF = true;
        } else {
            autoCompFF = true;
        ...
        autoCompShortFirstOnly = Globals.prefs.getAutoCompFirstNameMode().equals(JabRefPreferences.AUTOCOMPLETE_FIRSTNAME_MODE_ONLY_ABBR);
        autoCompFullFirstOnly = Globals.prefs.getAutoCompFirstNameMode().equals(JabRefPreferences.AUTOCOMPLETE_FIRSTNAME_MODE_ONLY_FULL);
    }
