...
class AppearancePrefsTab extends JPanel implements PrefsTab {
    ...
    public void setValues() {
        ...
        showGrid.setSelected(JabRefPreferences.getInstance().isTableShowGrid());
    ...
    public void storeSettings() {
        ...
        _prefs.setTableColorCodesOn(colorCodes.isSelected());
        //_prefs.putBoolean("antialias", antialias.isSelected());
        _prefs.setFontFamily(font.getFamily());
        _prefs.setFontStyle(font.getStyle());
        _prefs.setFontSize(font.getSize());
        _prefs.setOverrideDefaultFonts(overrideFonts.isSelected());
        GUIGlobals.CURRENTFONT = font;
        colorPanel.storeSettings();
        JabRefPreferences.getInstance().setTableShowGrid(showGrid.isSelected());
        try {
        ...
        try {
            ...
            _prefs.setTableRowPadding(padding);
        } catch (NumberFormatException ex) {
            ex.printStackTrace();
        }
    }
