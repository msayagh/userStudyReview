...
public class NetworkTab extends JPanel implements PrefsTab {
	...
	public void setValues() {
		...
		useProxy.setSelected(JabRefPreferences.getInstance().isUseProxy());
		//_prefs.putBoolean("defaultAutoSort", defSorrrt.isSelected());
		defProxyHostname.setText(_prefs.getProxyHostname());
		defProxyPort.setText(_prefs.getProxyPort());

	}

	@Override
	public void storeSettings() {
		JabRefPreferences.getInstance().setUseProxy(useProxy.isSelected());
		//_prefs.putBoolean("defaultAutoSort", defSorrrt.isSelected());
		_prefs.setProxyHostname(defProxyHostname.getText().trim());
		_prefs.setProxyPort(defProxyPort.getText().trim());
	}
