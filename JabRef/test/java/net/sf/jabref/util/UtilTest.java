...
public class UtilTest {
    ...
    public void testUserFieldAndFormat() {
        ...
        String[] names = Globals.prefs.getStringArray(NameFormatterTab.NAME_FORMATER_KEY, null);
        if (names == null) {
            names = new String[] {};
        }

        String[] formats = Globals.prefs.getStringArray(NameFormatterTab.NAME_FORMATTER_VALUE, null);
        if (formats == null) {
            formats = new String[] {};
        }
